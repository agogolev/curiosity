export const milestones = [
  ...
  },
  {
    ...
    description:
      "The figure has a human-like body but combines features from various animals. It is open to wide range of interpretations and might be a significant time mark of human believes.",
  ...
  },
  {
    ...
    description:
      "Hard evidence of prehistoric music attributed to Aurignacian culture.",
  ...
  },
  {
    ...
    description:
      "A nearly complete 'hobbit' female skeleton of a human that lived about 80,000 years ago in Liang Bua cave on the island of Flores, Indonesia. This woman lived on an isloated island in one ecosystem with dwarf elephants and komodo dragons, while five other hominid types where expending on the big land.",
